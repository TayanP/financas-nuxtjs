...
import Transaction from '~/components/Transactions/Transation'
...
export default {
  ...
  methods: {
    ...
    afterAdd(transaction) {
      /* está pegando a lista de transaction, e adicionando mais um */
...
<style scoped>   .slide-fade-enter-active {
